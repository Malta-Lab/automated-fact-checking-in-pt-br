...
CAMINHO_SAIDA = Path("../results_english/few_shot_only_statement_en.json")
...
EXAMPLES_FEW_SHOT = [
    ...
    {"statement": "Vaccines implant tracking microchips.", "label": "pants-on-fire"},
    {"statement": "Drinking saltwater cures cancer.", "label": "pants-on-fire"},
    {"statement": "Most refugees are criminals.", "label": "mostly-false"},
    {"statement": "Illegal immigrants have full access to Social Security.", "label": "mostly-false"},
